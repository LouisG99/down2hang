...
const handlers = {
    ...
    'FindAvailableFriends': function () {
        let say = 'Hello from FindAvailableFriends. ';
    ...
    //   SLOT: startTime 
        if (this.event.request.intent.slots.startTime.value) {
            ...
            slotStatus += ' slot startTime was heard as ' + startTime.value + '. ';
    ...
    //   SLOT: endTime 
        if (this.event.request.intent.slots.endTime.value) {
            ...
            slotStatus += ' slot endTime was heard as ' + endTime.value + '. ';
    ...
    'CreateGroup': function () {
        let say = 'Hello from CreateGroup. ';
